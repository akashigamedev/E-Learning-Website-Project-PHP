...
<form id="stuRegForm">
    ...
    <div class="mb-3">
        <i class="fas fa-envelope"></i><label for="stuemail" class="px-2 font-weight-bold">Email</label>
        <small id="statusMsg2"></small><input type="email" class="form-control" placeholder="Email" name="stuemail" id="stuemail">
